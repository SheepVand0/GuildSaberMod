...
namespace GuildSaber.Utils
{
    public static class GuildSaberUtils
    {
        ...
        {
            UnityEngine.Color l_Color0 = new UnityEngine.Color(p_Base.r * (1 + p_Difference) * p_Multiplier, p_Base.g * (1 + p_Difference) * p_Multiplier, p_Base.b * (1 + p_Difference) * p_Multiplier);
            UnityEngine.Color l_Color1 = new UnityEngine.Color(p_Base.r * (1 - p_Difference) * p_Multiplier, p_Base.g * (1 - p_Difference) * p_Multiplier, p_Base.b * (1 - p_Difference) * p_Multiplier);
        ...
        {
            return new UnityEngine.Color(p_Color.r + p_Value, p_Color.g + p_Value, p_Color.b + p_Value);
        }
        public static VertexGradient GetVerticalGradient(UnityEngine.Color p_Color0, UnityEngine.Color p_Color1)
        {
            return new VertexGradient(p_Color0, p_Color0, p_Color1, p_Color1);
        }
        ...
        {
            return new UnityEngine.Color(p_Color0.r * p_Color0Multiplier + p_Color1.r / 2, p_Color0.g * p_Color0Multiplier + p_Color1.g / 2, p_Color0.b * p_Color0Multiplier + p_Color1.b / 2);
        }
        ...
        {
            return new UnityEngine.Color(p_Color.r < p_Floor ? p_Floor : p_Color.r, p_Color.g < p_Floor ? p_Floor : p_Color.g, p_Color.g < p_Floor ? p_Floor : p_Color.g);
        }
