...
public class PlayerLevelUI : CustomUIComponent
{
    ...
    {
        get => "GuildSaber.UI.Card.View.PlayerLevelUI.bsml";
    }
...
////////////////////////////////////////////////////////////////////////////egion
    ...
    public static void ResetMenuCardPosition()
    {
        ...
        if (m_Instance != null) m_Instance.UpdateCardPosition();
    }
    ...
    /// </summary>
    /// <returns></returns>
    internal static bool GetIsCardActive() { return s_IsCardActive; }
}