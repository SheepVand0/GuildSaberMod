...
internal class GuildSaberLeaderboardPanel : BSMLAutomaticViewController
{
    ...
    [UIAction("#post-parse")] private void PostParse()
    {
        ...
        {
            if (p_Scene.name.ToLower().Contains("menu")) PanelInstance = this;
        };
    }
    ...
    protected override void DidDeactivate(bool removedFromHierarchy, bool screenSystemDisabling) { GSLogger.Instance.Log("Trying to deactivate panel", IPA.Logging.Logger.LogLevel.InfoUp); }
    ////////////////////////////////////////////////////////////////////////////
    ////////////////////////////////////////////////////////////////////////////
    ...
    public async void Reload(ReloadMode p_ReloadMode, bool p_SetLoadingModeBeforeGettingData, bool p_ReloadStyle)
    {
        ...
        if (p_ReloadStyle) {
            ...
            if (l_IconTexture.width <= 0 || l_IconTexture.height <= 0) l_IconTexture = l_DefaultLogo;
            ...
            // ReSharper disable once PossibleLossOfFraction
            var l_ResultTexture = new Texture2D(l_IconTexture.width, (int)(l_IconTexture.height / 4.5f - l_IconTexture.width / l_IconTexture.height - 1));
