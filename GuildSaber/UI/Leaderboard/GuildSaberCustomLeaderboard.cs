...
internal class GuildSaberCustomLeaderboard : CustomLeaderboard, IInitializable, IDisposable, INotifyLeaderboardLoad
{
    ...
    protected override ViewController panelViewController
    {
        get => m_PanelViewController;
    }
    protected override ViewController leaderboardViewController
    {
        get => m_LeaderboardViewController;
    }
    ...
    ///     Dispose
    /// </summary>
    public void Dispose() { m_CustomLeaderboardManager.Unregister(this); }
    ...
    {
        if (GSConfig.Instance.LeaderboardEnabled) m_CustomLeaderboardManager.Register(this);
    }
    ...
    public async void OnLeaderboardLoaded(bool p_Loaded)
    {
        ...
        if (m_LeaderboardViewController.gameObject.activeInHierarchy) LeaderboardLevelStatsViewManager.Hide();
    }
}
