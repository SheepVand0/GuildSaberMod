...
namespace GuildSaber.UI.Leaderboard.Components.SubComponents
{
    internal class LeaderboardScoreCell
    {
        ...
        private float InteractableScaleY => 6.5f * ScaleFactor * 0.9f;
        public static float ScoreFontSize => 2.5f * ScaleFactor;
        private float LeaderWidth => 90 * ScaleFactor + 7 * 1.4f;
        ...
        private void ShowInfo()
        {
            ...
            {
                if (!Modifiers.Contains(l_BannedModifier))
                {
                    continue;
                }
        ...
        private async void StartReplay()
        {
            ...
            ReplayerSettings l_Settings = new ReplayerSettings();
            ...
            ReplayerShortcuts l_Shortcuts = new ReplayerShortcuts();
            ...
            ReplayLaunchData l_Data = new ReplayLaunchData(l_Replay, BeatLeaderPlayer, null, null, l_Settings);
